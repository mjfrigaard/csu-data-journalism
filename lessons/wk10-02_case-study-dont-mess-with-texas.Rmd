...
comment: "Don't Mess with Texas Part 2: downloading files with `purrr`"
output: 
  html_document: 
    toc: yes
    toc_float: yes
...
ExecOffenders <- readr::read_csv("data/processed/2021-10-25/2021-10-25-ExecOffenders.csv")
ExOffndrsComplete <- readr::read_csv("data/processed/2021-10-25/2021-10-25-ExOffndrsComplete.csv")
```
