...
```{r}
TidyApple <- vroom::vroom(file = "https://raw.githubusercontent.com/mjfrigaard/csuc-data-journalism/gh-pages/data/2021-04-12-TidyApple.csv", delim = ",")
```
...
vroom::vroom_write(x = TidyApple, tidy_apple_out)
```
