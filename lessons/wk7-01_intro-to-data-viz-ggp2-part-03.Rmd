...
comment: "*trends, adding text, labeling values, and reference lines*"
output: 
  html_document: 
    toc: yes
    toc_float: yes
...
```{r TidyApple}
TidyApple <- vroom::vroom(file = "https://bit.ly/3CDGXlB", delim = ",")
head(TidyApple)
```


```{r export-tidy-apple, eval=FALSE, include=FALSE, message=FALSE, warning=FALSE}
# TidyApple 
fs::dir_create("../data/wk7-01_intro-to-ggp2-part-03/")
tidy_apple_out <- paste0("../data/wk7-01_intro-to-ggp2-part-03/", 
                         lubridate::today(), "-TidyApple.csv")
# tidy_apple_out
vroom::vroom_write(x = TidyApple, tidy_apple_out, delim = ",")
```
...
# top us cities 
top_us_cities_out <- paste0("../data/wk7-01_intro-to-ggp2-part-03/", 
                        base::noquote(lubridate::today()),
                                        "-TopUSCities.csv")
# top_us_cities_out
us_cities_out <- paste0("../data/wk7-01_intro-to-ggp2-part-03/", 
                        base::noquote(lubridate::today()),
                                        "-USCities.csv")
# us_cities_out
vroom::vroom_write(x = TopUSCities, file = top_us_cities_out, delim = ",")
vroom::vroom_write(x = USCities, file = us_cities_out, delim = ",")
```
