...
comment: "*building data displays with `flexdashboard`s storyboards*"
output: 
  html_document: 
    toc: yes
    toc_float: yes
...
All of the exercises and lessons are available [here](), but you can also read more about [`ggplot2`](https://ggplot2.tidyverse.org/index.html) on the tidyverse website, and in the [Data Visualisation](https://r4ds.had.co.nz/data-visualisation.html) chapter of R for Data Science.
...
# What should go into a storyboard?
