...
```{r bk00-01-cran.png-2, echo=FALSE}
knitr::include_graphics("img/bk00-01-cran.png")
```
...
knitr::include_graphics("img/bk00-10-win-cran.png")
```
...
```{r bk00-rtudio-win-download.png, echo=FALSE}
knitr::include_graphics("img/bk00-rtudio-win-download.png")
```
...
```{r bk00-rtools-win-download.png, echo=FALSE}
knitr::include_graphics("img/bk00-rtools-win-download.png")
```
...
```{r bk00-r-win-install-01.png, echo=FALSE}
knitr::include_graphics("img/bk00-r-win-install-01.png")
```

```{r bk00-r-win-install-02.png, echo=FALSE}
knitr::include_graphics("img/bk00-r-win-install-02.png")
```

```{r bk00-r-win-install-03.png, echo=FALSE}
knitr::include_graphics("img/bk00-r-win-install-03.png")
```


```{r bk00-r-win-install-04.png, echo=FALSE}
knitr::include_graphics("img/bk00-r-win-install-04.png")
```


```{r bk00-r-win-install-05.png, echo=FALSE}
knitr::include_graphics("img/bk00-r-win-install-05.png")
```


```{r bk00-r-win-install-06.png, echo=FALSE}
knitr::include_graphics("img/bk00-r-win-install-06.png")
```


```{r bk00-r-win-install-07.png, echo=FALSE}
knitr::include_graphics("img/bk00-r-win-install-07.png")
```


```{r bk00-r-win-install-08.png, echo=FALSE}
knitr::include_graphics("img/bk00-r-win-install-08.png")
```


```{r bk00-r-win-install-09.png, echo=FALSE}
knitr::include_graphics("img/bk00-r-win-install-09.png")
```

### Install Rtools

```{r bk00-rtools-install-01.png, echo=FALSE}
knitr::include_graphics("img/bk00-rtools-install-01.png")
```

```{r bk00-rtools-install-02.png, echo=FALSE}
knitr::include_graphics("img/bk00-rtools-install-02.png")
```

```{r bk00-rtools-install-03.png, echo=FALSE}
knitr::include_graphics("img/bk00-rtools-install-03.png")
```

```{r bk00-rtools-install-04.png, echo=FALSE}
knitr::include_graphics("img/bk00-rtools-install-04.png")
```

```{r bk00-rtools-install-05.png, echo=FALSE}
knitr::include_graphics("img/bk00-rtools-install-05.png")
```
