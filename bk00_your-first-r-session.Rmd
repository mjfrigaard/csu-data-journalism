...
- explain the differences between using the R console, .R script files, and RStudio   
...
A third option for using RStudio is setting up an [RStudio.Cloud](https://rstudio.cloud/) account. This requires a [Github account](https://github.com/) (**which you should set up first**). RStudio cloud is a service provided by RStudio that exists entirely in your browser. 
