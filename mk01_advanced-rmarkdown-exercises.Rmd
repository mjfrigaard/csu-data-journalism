---
title: "Advanced R Markdown Exercises"
comment: "*extending R markdown*"
output: 
  html_document: 
    toc: yes
    toc_float: yes
...
Please see the [accompanying slides]() for more information.
...
We can see the `mk01_advanced-rmarkdown-exercises_cache/html/` folder contents below:

```{r dir_tree-rmarkdown-exercises_cache, echo=FALSE}
fs::dir_tree("mk01_advanced-rmarkdown-exercises_cache/html/")
```
...
fs::dir_tree("mk01_advanced-rmarkdown-exercises_files/figure-html", regexp = "gg_avg_bmi_spec_gend")
```
