...
slides_img_folder <- "/Users/mjfrigaard/Dropbox/@projects/high-priority/@data-journalism/course-website/csuc-data-journalism/slides/img/"
    ...
    # cols
    image_folder_info <- dplyr::select(image_folder_info,
                                        img_path = path)
# file_name
...
image_info <- dplyr::filter(image_folder_info, 
       stringr::str_detect(string = file_name,
                           slide_image_regex))
...
```{r save-rmd-file, echo = FALSE, out.height="45%", out.width="45%", fig.align='center'}
...
```{r knit-rmd-file, echo = FALSE, out.height="40%", out.width="40%", fig.align='center'}
...
```{r yaml-highlight-theme, echo = FALSE, out.height="70%", out.width="70%", fig.align='center'}
...
```{r knitr-settings, echo = FALSE, out.height="60%", out.width="60%", fig.align='center'}
...
```{r delete-rmarkdown, echo = FALSE, out.height="70%", out.width="70%", fig.align='center'}
...
```{r tabset-markdown, echo = FALSE, out.height="85%", out.width="85%"}
...
```{r tabset-1-render, echo = FALSE, out.height="80%", out.width="80%", fig.align='center'}
...
```{r tabset-2-render, echo = FALSE, out.height="80%", out.width="80%", fig.align='center'}
...
```{r knitr-opts-set, echo = FALSE, out.height="75%", out.width="75%", fig.align='center'}
...
<br>
```{r kable-code-chunk, echo = FALSE, out.height="100%", out.width="100%", fig.align='center'}
...
```{r kable-chunk-rendered, echo = FALSE, out.height="82%", out.width="82%", fig.align='center'}
...
```{r paged-chunk-render, echo = FALSE, out.height="75%", out.width="75%", fig.align='center'}
...
```{r inline-code-rendered, echo = FALSE, out.height="80%", out.width="80%", fig.align='center'}
