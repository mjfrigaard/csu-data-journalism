...
```{r commands-console, eval=TRUE, echo=FALSE, out.height="70%", out.width="70%", fig.align='center'}
...
```{r store-explore, echo=FALSE, out.height='70%', out.width='70%', fig.align='center'}
