...
```{r ggplot2_masterpiece, out.height="70%", out.width="70%", echo = FALSE, fig.align='left'}
...
```{r color, out.height='70%', out.width='70%', fig.align='center'}
SmallNhanes %>% 
...
```{r size-point, out.height='70%', out.width='70%', fig.align='center'}
SmallNhanes %>% 
  ggplot(aes(x = weight, y = height)) + 
...
```{r shape-point, fig.align='center', out.height='70%', out.width='70%'}
SmallNhanes %>% 
  ggplot(aes(x = weight, y = height)) + 
...
```{r alpha-point, fig.align='center', out.height='70%', out.width='70%'}
SmallNhanes %>% 
  ggplot(aes(x = weight, y = height)) + 
...
```{r layer-1-plot-1, echo=FALSE, fig.align='center', out.width='60%', out.height='60%'}
SmallNhanes %>% 
  ggplot(aes(x = weight, y = height)) + # global #<<
  geom_point(aes(color = gender))
```
