...
subtitle: "stuff you'll use from the web"
...
<img src="img/00-538-example-01.png">
...
<img src="img/00-538-example-02.png">
...
<img src="img//00-wapo-covid-sparkline.png">
...
<img src="img/00-wapo-covid.gif">

<!--img/00-wapo-covid.png-->
...
<img src="img/00-pudding-office-01.png">
...
<img src="img/00-pudding-office-02.png">
...
### In the R, there are two primary components to the grammar (or sytnax):
...
> The function (`qplot()`) *does things* to 
...
```{r qplot-diamonds, fig.show='hide'}
qplot(data = diamonds, 
...
```{r ref.label='qplot-diamonds', echo=FALSE, fig.align='center', out.width='60%', out.height='60%'}
```
...
<img src="img/00-538-html-ref-00.png">
...
<img src="img/00-538-html-ref-01.png">
...
<img src="img/00-538-html-ref-02.png">
