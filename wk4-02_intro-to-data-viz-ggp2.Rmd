---
title: "Data Visualization with ggplot2 (multiple variable visualizations)"
comment: "*building graphs with multiple variables, advanced labeling, and facets/small multiples*"
output: 
  html_document: 
    toc: yes
    toc_float: yes
