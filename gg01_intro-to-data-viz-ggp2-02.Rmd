---
title: "Introduction to Data Visualization with ggplot2 (part 2)"
comment: "*Counting things, distributions, density/ridgeline/violin plots*"
output:
  html_document:
    toc: yes
    toc_float: yes
...
You'll want to export the `TidyApple` and `USCities` datasets for the next set of exercise. The code chunk below exports the dataset as a .csv with a date-stamp. 
