---
title: "Data Visualization with ggplot2 (single variable visualizations)"
comment: "*counting things and variable distributions with density, ridgeline, and violin plots*"
output: 
  html_document: 
    toc: yes
    toc_float: yes
...
All of the exercises and lessons are available [here](). Read more about [`ggplot2`](https://ggplot2.tidyverse.org/index.html) on the tidyverse website, and in the [Data Visualisation](https://r4ds.had.co.nz/data-visualisation.html) chapter of R for Data Science.
