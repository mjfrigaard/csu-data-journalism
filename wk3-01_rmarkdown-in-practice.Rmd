...
We can see the `mk01_rmarkdown-reports_cache/html/` folder contents below:

```{r mk01_rmarkdown-reports_cache, echo=FALSE}
fs::dir_tree("wk3-01_rmarkdown-in-practice_cache/html/")
```
...
fs::dir_tree("wk3-01_rmarkdown-in-practice_files/figure-html", regexp = "gg_avg_bmi_spec_gend")
```
