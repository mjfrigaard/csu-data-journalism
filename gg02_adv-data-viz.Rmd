...
### Label the lightest player

The `Lahman` dataset lists `Eddie Gaedel` as weighing `65` lbs. We will include this label with different colors. 

```{r BPMaybeLightest}
BPMaybeLightest <- BPBigSmall %>%  
  slice_min(weight)
BPMaybeLightest
```
...
lab_bbp_maybe_light <- labs(title = "Who is the lightest player?", 
                      subtitle = "The lighted player in Lahman database", 
                      x = "Weight in pounds", 
                      y = "Height in inches",
